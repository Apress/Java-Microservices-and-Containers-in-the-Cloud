...
public class KafkaConfig {
	 ...
	 @Value("${spring.kafka.bootstrap-servers}")
	  ...
	  @Bean
	  public CompletableFutureReplyingKafkaOperations<String, String, Products> replyKafkaTemplate() {
	    CompletableFutureReplyingKafkaTemplate<String, String, Products> requestReplyKafkaTemplate =
